...
def inicio():
    ...
    thread.start()
    anim = animation.FuncAnimation(fig, plotData, fargs=(
        muestraD, lines), interval=100, blit=False)
    plt.show()
...
label = Label(frame, textvariable=labelx, bg="#5CFE05", fg="black",
              font="Helvetica 13 bold", width=11, justify="center")
label.grid(row=0, column=0, padx=5, ipady=8, pady=10)

Iniciar = Button(frame, command=inicio, text="Iniciar ", bg="blue",
                 fg="white", font="Helvetica 14 bold", width=9, justify="center")
Iniciar.grid(row=1, column=0, padx=5, pady=5)

terminar = Button(frame, command=Terminar, text="Terminar",
                  bg="blue", fg="white", font="Helvetica 14 bold", width=9)
terminar.grid(row=2, column=0, padx=5, pady=5)

limpiar = Button(frame, command=Limpiar, text="Limpiar ", bg="blue",
                 fg="white", font="Helvetica 14 bold", width=9, justify="center")
limpiar.grid(row=3, column=0, padx=5, pady=5)

salir = Button(frame, command=Salir, width=9, text="SALIR",
               bg="red", font="Helvetica 14 bold", justify="center")
